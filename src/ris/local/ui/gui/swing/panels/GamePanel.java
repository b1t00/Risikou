...
public class GamePanel extends JPanel implements QuestionListener, WorldListener, RequestListener, UnitNumberListener{
...
//  private RequestPanel attackSecondPl;
	...
	public GamePanel(RisikoClientGUI client)
	{
		this.client = client;	
