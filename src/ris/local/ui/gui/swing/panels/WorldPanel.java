					...
					if (attackState == 1) {
						...
						if (ris.defenseLandGueltig(attackLand1, land)) {
							...
							JOptionPane.showMessageDialog(null,
									"Das Land gehört dir selber oder ist nicht mit dem Angriffsland benachbart!");
						}
					}
					break;
				case CHANGEUNITS:
					if (moveState == 1) {
						if (ris.moveFromLandGueltig(land)) {
							...
							JOptionPane.showMessageDialog(null,
									"Das Land gehört dir nicht oder du kannst von hier keine Einheiten verschieben.");
						}
					} else {
